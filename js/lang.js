const translations = {
  ca: {
    ...
    policyIntro: "Aquest lloc web respecta la teva privadesa i utilitza únicament galetes tècniques necessàries.",
    whatAreCookiesTitle: "Què són les galetes?",
    whatAreCookiesText: "Les galetes són petits fitxers de text que els llocs web que visites envien al teu navegador. Permeten que el web recordi informació sobre la teva visita per facilitar la següent.",
    howWeUseTitle: "Com utilitzem les galetes",
    techCookiesTitle: "Galetes Tècniques (Pròpies)",
    techCookiesText: "Són essencials per al correcte funcionament del web. Ens permeten gestionar el teu consentiment i preferències d'idioma.",
    noThirdPartyTitle: "Sense galetes de tercers",
    noThirdPartyText: "No utilitzem galetes d'anàlisi, publicitàries o de seguiment alienes a aquest lloc web.",
    tableId: "Identificador",
    tablePurpose: "Propòsit",
    tableDuration: "Durada",
    purposeConsent: "Recordar la teva elecció sobre la política de galetes d'aquest lloc.",
    purposeLang: "Recordar l'idioma seleccionat per a la navegació.",
    durationYear: "1 any",
    durationSession: "Sessió",
    configTitle: "La teva configuració",
    configText: "Com que només utilitzem galetes necessàries, no hi ha opció de rebutjar-les individualment, però pots esborrar les preferències.",
    btnBack: "Tornar a l'Inici",
    btnReset: "Resetejar les meves preferències",
    footerText: "Dubtes sobre la privadesa? Escriu-nos a",
    ...
    quisomP1: " Les entitats de la <b>Coordinadora de la Llengua de Barcelona</b> organitzen una jornada el 8 de maig a Sants dedicada a l’acollida sociolingüística de persones migrants joves i adultes. L’objectiu és crear un espai de <b>visibilització, formació i debat</b> sobre la tasca que fan diversos agents educatius i socials de la ciutat.",
    quisomP2: "La jornada reunirà professionals, voluntariat, docents, investigadors, responsables de polítiques públiques i persones participants en aquests processos per compartir experiències i analitzar reptes i èxits. També vol reforçar la formació en pràctiques inclusives, especialment davant la manca d’itineraris universitaris específics, i explorar millores en recursos, metodologies i coordinació.",
    ...
    horariText: "El centre estarà obert a partir de les 8:00 h per a l'acreditació.",
    ...
    inscripcioVenue: "Av. de les Drassanes, 3, Ciutat Vella",
    inscripcioAddress: "08001 Barcelona",
    ...
    contacteHeader: "Contacte",
    contacteHeroTitle: "Contacta amb nosaltres",
    contacteHeroDesc: "Tens dubtes? Vols col·laborar o necessites més informació sobre la Jornada? Estem aquí per ajudar-te.",
    contacteCoordTitle: "Coordinadora de la Llengua de Barcelona",
    contacteEmailLabel: "Correu electrònic",
    contactePhoneLabel: "Telèfon",
    contacteLocationLabel: "Lloc",
    contacteLocation: "Av. de les Drassanes, 3",
    contacteCity: "Barcelona",
    contacteDateLabel: "Data de la Jornada",
    contacteDate: "Divendres, 8 de maig de 2026",
    contacteMessageTitle: "Estem a la teva disposició",
    contacteMessageDesc: "Per qualsevol dubte, consulta o proposta de col·laboració, pots escriure'ns al correu electrònic. Respondrem el més aviat possible.",
    contacteEspecialment: "Especialment per a:",
    contacteItem1: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Inscripcions i places',
    contacteItem2: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Propostes de comunicacions, tallers o pòsters',
    contacteItem3: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Col·laboracions i patrocinis',
    ...
    content0: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-id-card text-3xl text-purple-700'></i><p>De 8:30 a 9:15 h. Recepció dels participants i lliurament d’acreditacions.</p></div>",
    content1: `
      <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
          <div class="flex items-center gap-3 mb-8">
              <i class="fa-solid fa-microphone-lines text-4xl text-purple-600"></i>
              <div>
                  <p class="text-lg font-semibold text-gray-800">9:30 - 9:45 h.</p>
                  <p class="text-purple-700 font-medium">Obertura de la jornada - Presentació oficial</p>
              </div>
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-8">
              ...
              <div class="text-center">
                  <div class="mx-auto w-24 h-24 bg-gray-200 rounded-2xl overflow-hidden mb-4 shadow-inner">
                      <img src="img/Gemma Verdés.jpeg" 
                            alt="Gemma Verdés" 
                            class="w-full h-full object-cover">
                  </div>
                  <h4 class="font-bold text-gray-900">Sra. Gemma Verdés</h4>
                  <p class="text-sm text-purple-700 mt-1 leading-tight">Directora General de Formació al Llarg de la Vida</p>
                  <p class="text-xs text-gray-500 mt-0.5">Departament d’Educació i Formació Professional</p>
              </div>
              ...
              <div class="text-center">
                  ...
                  <h4 class="font-bold text-gray-900">Sra. Vanessa Bretxa</h4>
                  <p class="text-sm text-purple-700 mt-1 leading-tight">Directora General d’Accés al Coneixement i Impuls de l’Ús del Català</p>
                  <p class="text-xs text-gray-500 mt-0.5">Departament de Política Lingüística</p>
              </div>
              ...
              <div class="text-center">
                  ...
                  <h4 class="font-bold text-gray-900">Sr. David Moya</h4>
                  <p class="text-sm text-purple-700 mt-1 leading-tight">Director General de Migracions i Refugi</p>
                  <p class="text-xs text-gray-500 mt-0.5">Departament de Drets Socials</p>
              </div>
        ...
        <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-purple-700 font-medium">Sessió inaugural</p>
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="flex-1">
                    ...
                    <div class="mb-6">
                        <p class="text-xl font-semibold text-purple-700">Manuela Simancas</p>
                        <p class="text-purple-600">Professora de l’àmbit TIC i directora del CFA Pau Casals de Rubí</p>
                    </div>

                    <div class="prose prose-gray prose-base max-w-none leading-relaxed text-gray-600">
                        <p>Mª Manuela Simancas és professora de l’àmbit TIC i directora del CFA Pau Casals de Rubí. Compagina aquesta tasca amb la docència universitària a la Universitat Autònoma de Barcelona.</p>
                        
                        <p>Amb 28 anys d’experiència, la seva trajectòria està vinculada a l’àmbit educatiu i al compromís amb el paper transformador de l’educació. Ha treballat en educació primària, secundària, centres penitenciaris, formació d’adults i universitat.</p>
                        
                        <p>Actualment centra la seva tasca en la investigació educativa, promovent la connexió entre entitats i defensant l’aprenentatge al llarg de la vida, especialment en educació d’adults.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    workshopIntro: "Els tallers pràctics aborden, des de perspectives diverses, els reptes i oportunitats de l’acollida sociolingüística i educativa en contextos de migració. Pensats per a alumnat, professorat, tècniques o voluntariat, els tallers combinen eines pedagògiques, experiències immersives i espais de reflexió col·lectiva per repensar pràctiques, ampliar mirades i construir entorns més justos, inclusius i connectats amb la realitat.",
    targetLabel: "Dirigit a",
    talleristaLabel: "Tallerista",
    bioLabel: "Bio:",

    // Taller A
    imgProgramaA: "<img src='img/A. Chaymae.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Chayma Rachdi Mennana'> ",
    ...
    // Taller B
    imgProgramaB: "<img src='img/B. Ana Taller.jpg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Anna Eguia Corral'>",
    ...
    // Taller C
    imgProgramaC: "<img src='img/C. Julia.jpg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Júlia Lompart Esbert'>",
    ...
    // Taller D
    imgProgramaD: "<img src='img/' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt=''>",
    ...
    // Taller E
    imgProgramaE: "<img src='img/E. Judith Olmo.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Judith Olmo'>",
    ...
    // Taller F
    imgProgramaF: "<img src='img/F. Fatima_Ahmed.JPG' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Fàtima Ahmed'> <img src='img/F. irene_garcía.JPG' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Irene García Blasi'>  ",
    ...
    // Taller G
    imgProgramaG: "<img src='img/G. Denis Olguin.jpg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Denise Olguín'>",
    ...
    imgComuniB: "<img src='img/B. Alba.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Alba'> <img src='img/B. Karla.png' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Karla'> <img src='img/B. Marta Vilar.png' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Marta Vilar'> ",

    // Comunicación C
    comC_Title: "COMUNICACIÓ C — Joves a l’aula: apropament a una intervenció sensibilitzada",
    ...
    imgComuniC: "<img src='img/C. Marisol i Mariana.jpg' class='w-40 h-30 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Marisol i Mariana'> ",

    // Comunicación D
    comD_Title: "COMUNICACIÓ D — WhatsApp com a eina de reforç en processos d’alfabetització",
    comD_Desc: "Reflexió sobre l’ús educatiu del WhatsApp com a suport per a grups d’alfabetització amb poques hores de classe. Després de dos anys d’experiència, es valoren els beneficis, els límits i els reptes de la incorporació d’aquesta eina digital com a reforç continuat.",
    comD_Target: "Alumnat, professorat, tècniques i voluntariat",
    comD_Name: "Alfons Formariz",

    comD_Bio: " Mestre de persones adultes i professor associat en alfabetització. Doctor en Societat i Educació, és secretari del Consell Assessor de Formació d’Adults. Col·labora amb EICA i El Turó Aprèn en projectes d’acollida i alfabetització.",
    imgComuniD: "<img src='img/D. Alfons Formaliz.jpg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Alfons Formaliz'> ",
    ...
    imgComuniE: "<img src='img/E. Emma Nevó.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Emma Nevó'> ",

    // Comunicación F
    comF_Title: "COMUNICACIÓ F — ORALPHA 1 i 2 + ORALPHA Digital: eines per a l’alfabetització i l’acollida lingüística",
    comF_Desc: "Presentació d’ORALPHA 1, ORALPHA 2 i del nou ORALPHA Digital, pensats per a l’alfabetització en contextos de migració. S’hi exploren les connexions amb el marc LASLLIAM i es debaten punts forts, febles i reptes actuals de l’alfabetització.",
    comF_Name: "Meritxell Vergara Lamarca",
    comF_Target: "Alumnat, professorat, tècniques i voluntariat",
    comF_Bio: "Antropòloga i coordinadora de Formació de Persones Adultes a Eicascantic. Professora d’alfabetització i formadora a ACOF, treballa en el disseny i implementació de materials i metodologies per a l’acollida lingüística",
    imgComuniF: "<img src='img/F. Meri.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Meritxell Vergara Lamarca'> ",
    ...
    imgComuniG: "<img src='img/G. Muniba Munur bé.png' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Muniba Munir Siraj'> ",
    ...
    imgComuniH: "<img src='img/H. Marta i Adriana.png' class='w-40 h-30 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Adriana Sabaté i Marta Miñambres'> ",



    content7: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-flag-checkered text-3xl text-purple-700'></i><p>14:30 – 14:45 h. Conclusions finals i cloenda.</p></div>",



    // Qui som? - Página completa
    quisomHeroPage: "Qui som? - I Jornada d’Acollida Sociolingüística",
    quisomHeroTitle: "Qui som? ",
    quisomHeroSubtitle: "Descobreix les entitats que fan possible la I Jornada d’Acollida Sociolingüística",

    quisomAcofTitle: "ACOF ",
    quisomAcofP1: "ACOF és una entitat formada per cinc organitzacions socials (<strong>Bayt Al-Thaqafa, Fundació Camins, Eicascantic, Escola de Vida i La Troca Sants</strong>) que, des de 2011, treballen en l’ensenyament de llengües i l’alfabetització de persones joves i adultes migrades.",
    ...
    quisomAcofBox: "Des de 2011 treballant per una millor acollida lingüística",
    ...
    quisomCoordItem1: "Coordina entitats del sector",
    quisomCoordItem2: "Comparteix recursos i metodologies",
    quisomCoordItem3: "Detecta necessitats comunes",
    quisomCoordItem4: "Impulsa accions conjuntes",
  ...
  es: {
    ...
    policyTitlePrefix: "Política de",
    policyIntro: "Este sitio web respeta tu privacidad y utiliza únicamente cookies técnicas necesarias.",
    whatAreCookiesTitle: "¿Qué son las cookies?",
    whatAreCookiesText: "Las cookies son pequeños archivos de texto que los sitios web que visitas envían a tu navegador. Permiten que el sitio web recuerde información sobre tu visita.",
    howWeUseTitle: "Cómo utilizamos las cookies",
    techCookiesTitle: "Cookies Técnicas (Propias)",
    techCookiesText: "Son aquellas esenciales para el correcto funcionamiento del sitio web. Nos permiten gestionar tu consentimiento y preferencias de idioma.",
    noThirdPartyTitle: "Sin cookies de terceros",
    noThirdPartyText: "No utilizamos cookies de análisis, publicitarias o de seguimiento ajenas a este sitio web.",
    tableId: "Identificador",
    tablePurpose: "Propósito",
    tableDuration: "Duración",
    purposeConsent: "Recordar tu elección sobre la política de cookies de este sitio.",
    purposeLang: "Recordar el idioma seleccionado para la navegación.",
    durationYear: "1 año",
    durationSession: "Sesión",
    configTitle: "Tu configuración",
    configText: "Dado que solo utilizamos cookies necesarias, no existe opción de rechazarlas individualmente, pero puedes borrar tus preferencias.",
    ...
    quisomP1: "Las entidades de la <b>Coordinadora de la Lengua de Barcelona</b> organizan una jornada el 8 de mayo en Sants dedicada a la acogida sociolingüística de personas migrantes jóvenes y adultas. El objetivo es crear un espacio de <b>visibilización, formación y debate</b> sobre la labor que llevan a cabo diversos agentes educativos y sociales de la ciudad.",
    quisomP2: "La jornada reunirá a profesionales, voluntariado, docentes, investigadores, responsables de políticas públicas y personas participantes en estos procesos para compartir experiencias y analizar retos y éxitos. También pretende reforzar la formación en prácticas inclusivas, especialmente ante la falta de itinerarios universitarios específicos, y explorar mejoras en recursos, metodologías y coordinación.",
    ...
    horariText: "El centro estará abierto a partir de las 8:00 h para la acreditación.",
    ...
    //Inscripcion
    inscripcioTitle: "Inscripción - I Jornada de Acogida Sociolingüística",
    inscripcioObertes: "Inscripciones abiertas",
    inscripcioHeroTitle: "Inscríbete en la Jornada",
    inscripcioHeroDesc: "La participación es gratuita pero las plazas son limitadas. Reserva tu plaza ahora mismo.",
    inscripcioDate: "8 de mayo de 2026",
    inscripcioDay: "Viernes",
    inscripcioVenue: "Av. de les Drassanes, 3, Ciutat Vella",
    inscripcioAddress: "08001 Barcelona",
    ...
    contacteItem1: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Inscripciones y plazas',
    contacteItem2: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Propuestas de comunicaciones, talleres o pósters',
    contacteItem3: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Colaboraciones y patrocinios',
    ...
    min30: "30 min", min60: "60 min", min45: "45 min", min15: "15 min", min75: "1h 15 min",
    content0: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-id-card text-3xl text-purple-700'></i><p>De 8:30 a 9:00 h. Recepción de los participantes y entrega de acreditaciones.</p></div>",
  ...
  <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
      <div class="flex items-center gap-3 mb-8">
          ...
          <div>
              <p class="text-lg font-semibold text-gray-800">9:30 - 9:45 h.</p>
              <p class="text-purple-700 font-medium">Apertura de la jornada - Presentación oficial</p>
          </div>
      </div>
      ...
      <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="text-center">
              ...
              <h4 class="font-bold text-gray-900">Sra. Gemma Verdés</h4>
              <p class="text-sm text-purple-700 mt-1 leading-tight">Directora General de Formación a lo Largo de la Vida</p>
              <p class="text-xs text-gray-500 mt-0.5">Departamento de Educación y Formación Profesional</p>
          </div>
          ...
          <div class="text-center">
              ...
              <h4 class="font-bold text-gray-900">Sra. Vanessa Bretxa</h4>
              <p class="text-sm text-purple-700 mt-1 leading-tight">Directora General de Acceso al Conocimiento e Impulso del Uso del Catalán</p>
              <p class="text-xs text-gray-500 mt-0.5">Departamento de Política Lingüística</p>
          </div>
          ...
          <div class="text-center">
              ...
              <h4 class="font-bold text-gray-900">Sr. David Moya</h4>
              <p class="text-sm text-purple-700 mt-1 leading-tight">Director General de Migraciones y Refugio</p>
              <p class="text-xs text-gray-500 mt-0.5">Departamento de Derechos Sociales</p>
          </div>
...
`,
    ...
    <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm overflow-hidden">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <p class="text-base font-semibold text-gray-800">9:45 h - 10:15 h.</p>
                <p class="text-purple-700 font-medium">Sesión inaugural</p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="flex-1">
                ...
                <div class="mb-6">
                    <p class="text-xl font-semibold text-purple-700">Manuela Simancas</p>
                    <p class="text-purple-600">Profesora del ámbito TIC y directora del CFA Pau Casals de Rubí</p>
                </div>

                <div class="prose prose-gray prose-base max-w-none leading-relaxed text-gray-600">
                    <p>Mª Manuela Simancas es profesora del ámbito TIC y directora del CFA Pau Casals de Rubí. Compagina esta labor con la docencia universitaria en la Universitat Autònoma de Barcelona.</p>
                    
                    <p>Con 28 años de experiencia, su trayectoria está vinculada al ámbito educativo y al compromiso con el papel transformador de la educación. Ha trabajado en educación primaria, secundaria, centros penitenciarios, formación de adultos y universidad.</p>
                    
                    <p>Actualmente centra su trabajo en la investigación educativa, promoviendo la conexión entre entidades y defendiendo el aprendizaje a lo largo de la vida, especialmente en la educación de personas adultas.</p>
                </div>
            </div>
        </div>
    </div>
`,
    ...
    // CAFÉ Y PAUSA
    content4: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-mug-hot text-3xl text-purple-700'></i><p>Este espacio ofrece una pausa con pica-pica para compartir, conocerse e intercambiar experiencias entre agentes, profesionales y entidades implicadas en la acogida sociolingüística. Además, incluye una exposición de pósters que muestran las entidades, explican su labor y visibilizan el trabajo realizado. Una oportunidad para fortalecer la red, generar vínculos y descubrir sinergias que mejoren la cooperación y las prácticas de acompañamiento.</p></div>",

    // === MESA REDONDA ===
    taulaRodonaTitle: "La acogida sociolingüística",
    ...
    imgComuniC: "<img src='img/C. Marisol i Mariana.jpg' class='w-40 h-30 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Marisol y Mariana'> ",
    ...
    comF_Desc: "Presentación de ORALPHA 1, ORALPHA 2 y el nuevo ORALPHA Digital, diseñados para la alfabetización en contextos de migración. Se exploran sus conexiones con el marco LASLLIAM y se debaten fortalezas, debilidades y retos actuales de la alfabetización.",
    comF_Name: "Meritxell Vergara Lamarca",
    comF_Target: "Alumnado, profesorado, personal técnico y voluntariado",
    comF_Bio: "Antropóloga y coordinadora de Formación de Personas Adultas en Eicascantic. Profesora de alfabetización y formadora en ACOF, trabaja en el diseño e implementación de materiales y metodologías para la acogida lingüística.",
    imgComuniF: "<img src='img/F. Meri.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Meritxell Vergara Lamarca'> ",
    ...
    imgComuniH: "<img src='img/H. Marta i Adriana.png' class='w-40 h-30 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Adriana Sabaté y Marta Miñambres'> ",

    content7: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-flag-checkered text-3xl text-purple-700'></i><p>14:30 – 14:45 h. Conclusiones finales y clausura.</p></div>",
    ...
    quisomAcofTitle: "ACOF",
    quisomAcofP1: "ACOF es una entidad formada por cinco organizaciones sociales (<strong>Bayt Al-Thaqafa, Fundació Camins, Eicascantic, Escola de Vida y La Troca Sants</strong>) que, desde 2011, trabajan en la enseñanza de lenguas y la alfabetización de personas jóvenes y adultas migrantes.",
    ...
    quisomAcofBox: "Desde 2011 trabajando por una mejor acogida lingüística",
    ...
    quisomCoordItem1: "Coordina entidades del sector",
    quisomCoordItem2: "Comparte recursos y metodologías",
    quisomCoordItem3: "Detecta necesidades comunes",
    quisomCoordItem4: "Impulsa acciones conjuntas",
  ...
  en: {
    ...
    policyIntro: "This website respects your privacy and only uses necessary technical cookies.",
    whatAreCookiesTitle: "What are cookies?",
    whatAreCookiesText: "Cookies are small text files sent to your browser by the websites you visit. They help the website remember information about your visit.",
    howWeUseTitle: "How we use cookies",
    techCookiesTitle: "Technical Cookies (First-party)",
    techCookiesText: "These are essential for the website to function correctly. They allow us to manage your consent and language preferences.",
    noThirdPartyTitle: "No third-party cookies",
    noThirdPartyText: "We do not use analytics, advertising, or tracking cookies from outside this website.",
    tableId: "Identifier",
    tablePurpose: "Purpose",
    tableDuration: "Duration",
    purposeConsent: "Remember your choice regarding the cookie policy of this site.",
    purposeLang: "Remember the language selected for navigation.",
    durationYear: "1 year",
    durationSession: "Session",
    configTitle: "Your settings",
    configText: "Since we only use necessary cookies, there is no option to reject them individually, but you can clear your preferences at any time.",
    ...
    quisomP1: "The organizations of the <b>Barcelona Language Coordination Platform</b> are organizing an event on May 8 in Sants focused on the sociolinguistic integration of young and adult migrants. The aim is to create a space for <b>visibility, training, and debate</b> on the work carried out by various educational and social agents in the city.",
    quisomP2: "The event will bring together professionals, volunteers, teachers, researchers, public policy makers, and participants involved in these processes to share experiences and analyze challenges and successes. It also aims to strengthen training in inclusive practices, especially given the lack of specific university pathways, and to explore improvements in resources, methodologies, and coordination.",
    ...
    horariText: "The center opens at 8:00 AM for accreditation.",
    ...
    //Inscripcion
    inscripcioTitle: "Registration - 1st Sociolinguistic Welcome Conference",
    inscripcioObertes: "Registration open",
    inscripcioHeroTitle: "Register for the Conference",
    inscripcioHeroDesc: "Participation is free but places are limited. Reserve your spot now.",
    inscripcioDate: "May 8, 2026",
    inscripcioDay: "Friday",
    inscripcioVenue: "Av. de les Drassanes, 3, Ciutat Vella",
    inscripcioAddress: "08001 Barcelona",
    ...
    contacteItem1: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Registrations and places',
    contacteItem2: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Proposals for communications, workshops or posters',
    contacteItem3: '<i class="fa-solid fa-circle text-purple-500 text-xs mt-1.5"></i> Collaborations and sponsorships',
    ...
    progHeroTitle: "Event Program",
    heroTime: "8:30 am - 2:45 pm",
    downloadBtn: "Download program in PDF",

    card0_Title: "Registration and Welcome",
    card1_Title: "Opening of the event",
    card2_Title: "Opening session",
    card3_Title: "Workshops and presentations",
    card4_Title: "Coffee break and networking",
    card5_Title: "Communications",
    card6_Title: "Round table",
    card7_Title: "Closing",



    min30: "30 min", min60: "60 min", min45: "45 min", min15: "15 min", min75: "1h 15 min",
    content0: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-id-card text-3xl text-purple-700'></i><p>From 8:30 to 9:00 am. Participant reception and accreditation distribution.</p></div>",
    content1: `
      <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
          <div class="flex items-center gap-3 mb-8">
              <i class="fa-solid fa-microphone-lines text-4xl text-purple-600"></i>
              <div>
                  <p class="text-lg font-semibold text-gray-800">9:30 - 9:45 am</p>
                  <p class="text-purple-700 font-medium">Opening of the event - Official presentation</p>
              </div>
          </div>
          ...
          <div class="grid md:grid-cols-3 gap-8">
              ...
              <div class="text-center">
                  ...
                  <h4 class="font-bold text-gray-900">Ms. Gemma Verdés</h4>
                  <p class="text-sm text-purple-700 mt-1 leading-tight">Director General for Lifelong Learning</p>
                  <p class="text-xs text-gray-500 mt-0.5">Department of Education and Vocational Training</p>
              </div>
              ...
              <div class="text-center">
                  ...
                  <h4 class="font-bold text-gray-900">Ms. Vanessa Bretxa</h4>
                  <p class="text-sm text-purple-700 mt-1 leading-tight">Director General for Access to Knowledge and Promotion of Catalan Use</p>
                  <p class="text-xs text-gray-500 mt-0.5">Department of Language Policy</p>
              </div>
              ...
              <div class="text-center">
                  ...
                  <p class="text-sm text-purple-700 mt-1 leading-tight">Director General for Migration and Refuge</p>
                  <p class="text-xs text-gray-500 mt-0.5">Department of Social Rights</p>
              </div>
    ...
    <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm overflow-hidden">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <p class="text-base font-semibold text-gray-800">9:45 am - 10:15 am</p>
                <p class="text-purple-700 font-medium">Opening session</p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="flex-1">
                <h3 class="text-2xl font-bold leading-tight text-gray-900 mb-5">
                    Professionals who connect, communities that grow: Recognition and networking in language learning
                </h3>
                
                <div class="mb-6">
                    <p class="text-xl font-semibold text-purple-700">Manuela Simancas</p>
                    <p class="text-purple-600">ICT teacher and director of CFA Pau Casals in Rubí</p>
                </div>

                <div class="prose prose-gray prose-base max-w-none leading-relaxed text-gray-600">
                    <p>Mª Manuela Simancas is an ICT teacher and director of CFA Pau Casals in Rubí. She combines this role with university teaching at the Universitat Autònoma de Barcelona.</p>
                    
                    <p>With 28 years of experience, her career is linked to the educational field and a strong commitment to the transformative role of education. She has worked in primary and secondary education, prisons, adult education, and university settings.</p>
                    
                    <p>She currently focuses on educational research, promoting connections between organizations and advocating for lifelong learning, especially in adult education.</p>
                </div>
            </div>
        </div>
    </div>
`,
    ...
    imgComuniC: "<img src='img/C. Marisol i Mariana.jpg' class='w-40 h-30 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Marisol and Mariana'> ",
    ...
    imgComuniE: "<img src='img/E. Emma Nevó.jpeg' class='w-20 h-20 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Emma Navó'> ",
    ...
    imgComuniH: "<img src='img/H. Marta i Adriana.png' class='w-40 h-30 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Adriana Sabaté and Marta Miñambres'> ",


    content7: "<div class='flex items-center gap-4 bg-purple-50 p-6 rounded-2xl'><i class='fa-solid fa-flag-checkered text-3xl text-purple-700'></i><p>2:30 – 2:45 pm. Final conclusions and closing.</p></div>",
    ...
    quisomAcofTitle: "ACOF",
    quisomAcofP1: "ACOF is an entity formed by five social organizations (<strong>Bayt Al-Thaqafa, Fundació Camins, Eicascantic, Escola de Vida and La Troca Sants</strong>) that, since 2011, work on language teaching and literacy for young and adult migrants.",
    ...
    quisomAcofBox: "Since 2011 working for better linguistic reception",
...
function changeLanguage(lang) {
  ...
  if (activeCard) {
    const index = activeCard.id.split('-')[1];
    showDetail(parseInt(index));
  }

  // 4. NUEVO: Actualizar el estado visual de los botones
  updateActiveButton(lang);
}

// Lógica de visualización de detalles (solo para programa.html)
function showDetail(index) {
  ...
  detailTitle.innerText = t[`card${index}_Title`];

  if (index === 3) {

    detailText.innerHTML = renderWorkshops(t);
  }
  else if (index === 5) {
    detailText.innerHTML = rendercomunicacion(t);

  } else if (index === 6) {
    detailText.innerHTML = renderTaulaRodona(t);
  }
  else {
    // Resto de cards (acreditación, apertura, etc.)
    detailText.innerHTML = t[`content${index}`] || "<p>Contenido no disponible</p>";
  }
}
...
function renderWorkshops(t) {
  ...
  letters.forEach(letter => {
    ...
    const desc = t['taller' + letter + '_Desc'];
    const target = t['taller' + letter + '_Target'];
    const name = t['taller' + letter + '_Name'];
    const bio = t['taller' + letter + '_Bio'];
...
function updateActiveButton(lang) {
  ...
  // 2. Buscamos el botón específico por su ID y le añadimos la clase
...
function toggleBio(letter, btn) {
  ...
  if (bio.classList.contains('expanded')) {
    ...
    // 🔼 EXPANDIR
    bio.style.maxHeight = bio.scrollHeight + "px"; // altura real
