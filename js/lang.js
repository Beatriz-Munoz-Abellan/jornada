            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="flex-1">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-[#7a044b]">Professora de l’àmbit TIC i directora del CFA Pau Casals de Rubí</p>
                    </div>
    ...
    <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm overflow-hidden">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-[#7a044b] font-medium">Opening session</p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="flex-1">
                ...
                <div class="mb-6">
                    <p class="text-xl font-semibold text-[#7a044b]">Manuela Simancas</p>
                    <p class="text-[#7a044b]">ICT teacher and director of CFA Pau Casals in Rubí</p>
                </div>

                <div class="prose prose-gray prose-base max-w-none leading-relaxed text-justify text-gray-600">
                    <p>Mª Manuela Simancas is an ICT teacher and director of CFA Pau Casals in Rubí. She combines this role with university teaching at the Universitat Autònoma de Barcelona.
                    With 28 years of experience, her career is linked to the educational field and a strong commitment to the transformative role of education. She has worked in primary and secondary education, prisons, adult education, and university settings.
                    She currently focuses on educational research, promoting connections between organizations and advocating for lifelong learning, especially in adult education.</p>
                </div>
            </div>
        </div>
    </div>
...
function renderWorkshops(t) {
  ...
  let html = `
    <div class="space-y-10 sm:space-y-12">
        ...
        <!-- CABECERA -->
        <div class="relative overflow-hidden bg-gradient-to-r from-[#7a044b] to-[#9c0a5f] text-white p-6 sm:p-8 lg:p-10 rounded-3xl shadow-2xl">
            <div class="relative text-justify z-10">
                <h3 class="text-lg sm:text-xl font-bold mb-4 flex items-center gap-2">
                    <i class="fa-solid fa-circle-info"></i> ${t.workshopTitle}
                </h3>
                <p class="text-purple-100 leading-relaxed text-base sm:text-lg">
                    ${t.workshopIntro}
                </p>
            </div>
        </div>
          ...
          <div class="flex flex-col lg:flex-row gap-6 sm:gap-10 lg:gap-12">
            ...
            <div class="flex-[1.5]">
              <div class="flex flex-wrap items-center gap-3 mb-5">
                <span class="bg-purple-100 text-[#7a044b] text-xs sm:text-sm font-bold px-3 py-1 rounded-full uppercase">
                  ${letter}
                </span>
                <span class="flex items-center gap-2 text-gray-500 text-xs sm:text-sm font-medium">
                  <i class="fa-solid fa-users text-[#7a044b]/40"></i> ${target}
                </span>
              </div>
            ...
            <div class="flex-1">
              <div class="bg-gray-50 rounded-2xl p-5 sm:p-8 border border-gray-100 h-full">
                ...
                <div class="flex flex-col items-center text-center mb-6">
                  ...
                  <span class="text-[#7a044b] font-semibold text-xs sm:text-sm uppercase mt-1">
                    ${t.talleristaLabel}
                  </span>
                </div>

                <div class="relative"> 
               <i class="fa-solid fa-quote-left text-[#7a044b]/20 absolute -left-2 -top-2 text-2xl"></i> 
               <p id="bio-${letter}" class="bio-text text-justify text-gray-600 text-sm italic leading-relaxed pl-4 line-clamp-4"> ${bio} </p> 
               <button onclick="toggleBio('${letter}', this)" class="mt-3 text-[#7a044b] font-semibold text-sm hover:underline"> 
...
function rendercomunicacion(t) {
  ...
  let html = `
    <div class="relative overflow-hidden bg-gradient-to-r from-[#7a044b] to-[#9c0a5f] text-white p-6 sm:p-8 lg:p-10 rounded-3xl shadow-2xl mb-10 sm:mb-12">
      <h3 class="text-lg sm:text-xl font-bold mb-4 flex items-center gap-2">
        <i class="fa-solid fa-microphone"></i> ${t.comunicacionsTitle}
      </h3>
      <p class=" text-justify text-base sm:text-lg">
      ...
      <section class="bg-white rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden">
        <div class="p-5 sm:p-8 lg:p-12">
          <div class="flex flex-col lg:flex-row gap-6 sm:gap-10 lg:gap-12">
            ...
            <div class="flex-[1.5]">
              <div class="flex flex-wrap items-center gap-3 mb-5">
                <span class="bg-purple-100 text-[#7a044b] text-xs sm:text-sm font-bold px-3 py-1 rounded-full">
                  ${letter}
                </span>
            ...
            <div class="flex-1">
              <div class="bg-gray-50 rounded-2xl p-5 sm:p-8 border border-gray-100 h-full">
                ...
                <div class="relative"> 
                    <i class="fa-solid fa-quote-left text-[#7a044b]/20 absolute -left-2 -top-2 text-2xl"></i> 
                    <p id="bio-${letter}" class="bio-text text-gray-600 text-sm italic text-justify leading-relaxed pl-4 line-clamp-4"> ${bio} </p> 
                    <button onclick="toggleBio('${letter}', this)" class="mt-3 text-[#7a044b] font-semibold text-sm hover:underline"> 
  ...
  return `
    <div class="space-y-10 sm:space-y-12">
      ...
      <div class="relative overflow-hidden bg-gradient-to-r from-[#7a044b] to-[#9c0a5f] text-white p-6 sm:p-8 lg:p-10 rounded-3xl shadow-2xl mb-10 sm:mb-12">
        ...
        <p class=" text-base sm:text-lg text-justify">${t.taulaRodonaDesc}</p>
      </div>
  ...
  return `
    <div class="bg-white rounded-3xl border shadow-sm p-6 sm:p-8 lg:p-10 flex flex-col md:flex-row gap-6 sm:gap-8 items-center">
      ...
      <div class="text-center md:text-left">
        ...
        <p class="text-[#7a044b] text-xs sm:text-sm uppercase mb-3">${t.taulaRodonaPonentLabel}</p>
        <p class="text-gray-600 text-sm sm:text-base text-justify">${bio}</p>
      </div>
